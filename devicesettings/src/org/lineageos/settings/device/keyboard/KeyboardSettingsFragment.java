...
public class KeyboardSettingsFragment extends PreferenceFragment
    ...
    private SwitchPreference mKeymapMissingKeyPref;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mKeymapMissingKeyPref = findPreference(Constants.KEYBOARD_KEYMAP_MISSING_KEY_KEY);
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        switch (key) {
            ...
            case Constants.KEYBOARD_KEYMAP_MISSING_KEY_KEY:
                doUpdateKeymapPreferences();
                break;
    ...
    private void doUpdateLayoutPreference() {
        ...
        mKeymapMissingKeyPref.setChecked(false);
    }
    ...
    private void doUpdateKeymapPreferences() {
        ...
        mKeymapMissingKeyPref.setEnabled(true);
        ...
        if (mKeymapCustomPref.isChecked()) {
            if (KeyboardUtils.installCustomKeymap()) {
                ...
                mKeymapMissingKeyPref.setChecked(false);
                mKeymapMissingKeyPref.setEnabled(false);
            } else {
                mKeymapCustomPref.setChecked(false);
        ...
        if (mKeymapMissingKeyPref.isChecked()) {
            for (int i = 0; i < Constants.KEYBOARD_KEYMAP_MISSING_KEY_TEXT.length; ++i) {
               KeyboardUtils. writeFile(Constants.KEYBOARD_KEYMAP_SYS_FILE,
                        Constants.KEYBOARD_KEYMAP_MISSING_KEY_TEXT[i] + "\n");
            }
            mKeymapCustomPref.setChecked(false);
        }
    }
