...
public class TouchscreenSettingsFragment extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mMarginSeekBar = findPreference(TouchscreenConstants.TOUCHSCREEN_MARGIN_KEY);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPrefs, String key) {
        if (TouchscreenConstants.TOUCHSCREEN_MARGIN_KEY.equals(key)) {
            doUpdateMarginPreference();
        }
    }
    ...
    private void doUpdateMarginPreference() {
        ...
        final int margin = TouchscreenConstants.TOUCHSCREEN_MARGIN_STEP *
                mPrefs.getInt(TouchscreenConstants.TOUCHSCREEN_MARGIN_KEY,
