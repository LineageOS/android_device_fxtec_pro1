...
public class KeyboardUtils {
    ...
    public static void setKeymap(SharedPreferences prefs) {
        ...
        boolean enabled = prefs.getBoolean(Constants.KEYBOARD_KEYMAP_CUSTOM_KEY, false);
        if (enabled) {
            ...
            boolean value = prefs.getBoolean(Constants.KEYBOARD_KEYMAP_SPACEPOWER_KEY, false);
            if (value) {
