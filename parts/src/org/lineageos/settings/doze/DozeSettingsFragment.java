...
public class DozeSettingsFragment extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mAlwaysOnDisplayPreference = findPreference(DozeConstants.ALWAYS_ON_DISPLAY_KEY);
        ...
        if (!DozeUtils.alwaysOnDisplayAvailable(getActivity())) {
            ...
            tiltSensorCategory.setDependency(DozeConstants.ALWAYS_ON_DISPLAY_KEY);
            proximitySensorCategory.setDependency(DozeConstants.ALWAYS_ON_DISPLAY_KEY);
        }
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (DozeConstants.ALWAYS_ON_DISPLAY_KEY.equals(preference.getKey())) {
